...
const allPermissions = [
  ...
  'manage_procurement_queue',
  'manage_supplier_quotations',
  'manage_approved_suppliers',
  'view_pricing_intelligence',
...
const blueprintRoles: BlueprintRole[] = [
  ...
  },
  {
    ...
    responsibilities: [
      'Qualify new leads and route them to the correct team',
      'Capture buyer intent, requirement details, and follow-ups',
      'Hand off validated leads to Sales',
      'Keep lead status, notes, and meeting history updated',
    ],
    access: ['Lead Qualification', 'Lead Status', 'Follow-Ups', 'Call Notes', 'Meeting Scheduling'],
    restrictions: ['No Quotations', 'No Orders', 'No Procurement', 'No Finance'],
    accent: 'green',
  },
  {
    title: 'Sales',
    subtitle: 'Quotations + Orders + Customers',
    responsibilities: [
      'Create and manage quotations',
      'Handle customer management and follow-up',
      'Convert quotations into confirmed orders',
      'Keep negotiations and customer communication current',
    ],
    access: ['Quotations', 'Orders', 'Customer Management', 'Negotiation Tracking', 'Sales Inbox'],
    restrictions: ['No Inventory Control', 'No Dispatch Control', 'No Finance Control'],
    accent: 'blue',
  },
  {
    title: 'Procurement',
    subtitle: 'Pricing + Vendors + RFQ + Purchase Order',
    responsibilities: [
      'Check pricing and cost intelligence',
      'Manage approved vendors and supplier selection',
      'Create and track RFQs',
      'Raise purchase orders after final cost approval',
    ],
    access: ['Pricing Intelligence', 'Approved Suppliers', 'RFQs', 'Supplier Quotations', 'Purchase Orders'],
    restrictions: ['No Product Master Changes', 'No Finance Approval', 'No User Management'],
    accent: 'gold',
  },
  {
    title: 'Admin',
    ...
    responsibilities: [
      'Manage product catalog and master data',
      'Maintain inventory and warehouse masters',
      'Handle product approvals and category setup',
      'Keep stock-related records accurate',
    ],
    access: ['Products', 'Categories', 'Inventory', 'Warehouses', 'Brands', 'Documents'],
